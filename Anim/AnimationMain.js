...
function animWaiting()
{
	...
	objectManager.statusReport.setText("Пауза");
...
function animStarted()
{
	...
	objectManager.statusReport.setText("Анимация");
...
function animEnded()
{
	...
	objectManager.statusReport.setText("Готово");
...
function initCanvas()
{
	...
	skipBackButton = addControlToAnimationBar("Button", "К началу");
	...
	stepForwardButton = addControlToAnimationBar("Button", "Шаг вперед");
	stepForwardButton.onclick = animationManager.step.bind(animationManager) ;
	skipForwardButton = addControlToAnimationBar("Button", "К окончанию");
	...
	heightEntry.size = 4;
	sizeButton = addControlToAnimationBar("Button", "Изменить размер холста	");
	
	sizeButton.onclick = animationManager.changeSize.bind(animationManager) ;
	

        swapButton = addControlToAnimationBar("Button", "Изменить позицию");
